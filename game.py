...
while not game_over:
    ...
    if money <= 0:
        ...
        print(f"{bcolors.RED}{bcolors.BOLD}Time is up!{bcolors.ENDC}")
        game_over = True
    if win:
        print(f'Congratulations, you found the {pet}, and you have {bcolors.GREEN}{money:.0f}${bcolors.ENDC} left for your vacation!')
        game_over = True
